...
class ButtonsApp(App, FloatLayout):
    ...
    def move_window(self, *args):
        ...
        if window_move_resize_active == 'Y':
            Window.left = start_window_left + (ButtonsApp.last_mouse_pos_x - start_pos_x)
            Window.top = start_window_top + (ButtonsApp.last_mouse_pos_y - start_pos_y)
            Window.last_screen_pos_left = Window.left
            Window.last_screen_pos_top = Window.top
    ...
    def size_window(self, *args):
        ...
        if window_move_resize_active == 'Y':
            if window_resize_feature == 'n_s':
                ...
                Window.size = [start_window_width, start_window_height + (ButtonsApp.last_mouse_pos_y - start_pos_y)]
            if window_resize_feature == 'nw_se':
                Window.disable_on_restore = 'Y'
                Window.size = [start_window_width + (ButtonsApp.last_mouse_pos_x - start_pos_x), start_window_height + (ButtonsApp.last_mouse_pos_y - start_pos_y)]
            if window_resize_feature == 'w_e':
                Window.disable_on_restore = 'Y'
                Window.size = [start_window_width + (ButtonsApp.last_mouse_pos_x - start_pos_x), start_window_height]
